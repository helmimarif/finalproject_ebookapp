...
import 'package:finalproject_ebookapp/component/body_builder.dart';
import 'package:finalproject_ebookapp/component/sampul_buku.dart';
import 'package:finalproject_ebookapp/component/list_buku.dart';
import 'package:finalproject_ebookapp/models/kategori.dart';
import 'package:finalproject_ebookapp/util/consts.dart';
import 'package:finalproject_ebookapp/util/router.dart';
import 'package:finalproject_ebookapp/view_models/home_provider.dart';
import 'package:finalproject_ebookapp/views/genre/genre.dart';
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        children: <Widget>[
          ...
          SizedBox(height: 20.0),
          _buildSectionTitle('Baru saja ditambahkan'),
          SizedBox(height: 20.0),
